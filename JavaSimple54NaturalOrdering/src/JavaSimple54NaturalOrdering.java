...
//  Java Simple 54; Natural Ordering

import java.util.NoSuchElementException;
import java.util.Queue;
import java.util.concurrent.ArrayBlockingQueue;

public class JavaSimple54NaturalOrdering {
    public static void main(String[] args) {
        // (head)<- oooooooooooooooooooooooooooooooo <- (tail) FIFO (first in,
        // first out)
        ...
        try {
            ...
            System.out.println("Tried to add too many items to queue");
        }
