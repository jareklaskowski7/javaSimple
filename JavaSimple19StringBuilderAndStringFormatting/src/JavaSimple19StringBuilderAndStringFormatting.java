...
//  Java Simple 19; String Builder And String Formatting

public class JavaSimple19StringBuilderAndStringFormatting {
    public static void main(String[] args) {
        ...
        // a formatted string.
        String formatted2 = String.format("Here is a message: %-2.3f", 9.7);
        System.out.println(formatted2);
        String formatted = String.format(
                "This is a floating-point value: %.3f", 5.12345);
